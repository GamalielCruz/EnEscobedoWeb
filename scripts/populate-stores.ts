 ...
 * Ejecutar con: npx tsx scripts/populate-stores.ts
 */
...
async function populateStores() {
  try {
    ...
    if (existingStores.length > 0) {
      ...
      console.log('¿Deseas continuar? Esto agregará más tiendas.');
      // En un entorno real, podrías usar readline para confirmar
    }

    ...
    (
      {
        ...
        onDeclineCallback = () => {},
        className,
        description = "Utilizamos cookies para garantizar que obtengas la mejor experiencia en nuestro sitio web. Para más información consulta nuestra política de privacidad.",
        learnMoreHref = "#",
        ...props
      },
      ref,
